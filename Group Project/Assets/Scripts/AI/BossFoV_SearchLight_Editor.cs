...
[CustomEditor(typeof(BossFoV_SearchLight))] // CustomEditor is running off 'BossFoV_SearchLight' script.

public class BossFoV_SearchLight_Editor : Editor // Base class to derive custom Editors from. Used to create custom inspectors and editors for objects.
{
    ...
    void OnSceneGUI()
    {
        ...
        BossFoV_SearchLight fow = (BossFoV_SearchLight)target;
